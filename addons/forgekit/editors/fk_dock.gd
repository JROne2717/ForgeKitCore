...
const RESOURCE_TYPES := {
	"FKStat": "res://addons/forgekit/resources/fk_stat.gd",
	"FKDerivedStat": "res://addons/forgekit/resources/fk_derived_stat.gd",
	"FKClass": "res://addons/forgekit/resources/fk_class.gd",
	"FKEnemy": "res://addons/forgekit/resources/fk_enemy.gd",
	"FKItem": "res://addons/forgekit/resources/fk_item.gd",
	"FKAbility": "res://addons/forgekit/resources/fk_ability.gd",
	"FKPassiveSkill": "res://addons/forgekit/resources/fk_passive_skill.gd",
	"FKSkillTree": "res://addons/forgekit/resources/fk_skill_tree.gd",
	"FKLootTable": "res://addons/forgekit/resources/fk_loot_table.gd",
	"FKEncounterTable": "res://addons/forgekit/resources/fk_encounter_table.gd",
	"FKZone": "res://addons/forgekit/resources/fk_zone.gd",
	"FKDialogue": "res://addons/forgekit/resources/fk_dialogue.gd",
	"FKQuest": "res://addons/forgekit/resources/fk_quest.gd",
}

const SCENE_TEMPLATES := {
	"Battle Scene": "res://addons/forgekit/scenes/templates/battle_scene.tscn",
	"Overworld Scene": "res://addons/forgekit/scenes/templates/overworld_scene.tscn",
	"Title Screen": "res://addons/forgekit/scenes/templates/title_screen.tscn",
	"Game Over Screen": "res://addons/forgekit/scenes/templates/game_over_screen.tscn",
	"Dialogue Scene": "res://addons/forgekit/scenes/templates/dialogue_scene.tscn",
	"Shop Scene": "res://addons/forgekit/scenes/templates/shop_scene.tscn",
	"Inventory Screen": "res://addons/forgekit/scenes/templates/inventory_screen.tscn",
	"Party Menu": "res://addons/forgekit/scenes/templates/party_menu.tscn",
	"Save/Load Screen": "res://addons/forgekit/scenes/templates/save_load_screen.tscn",
}
...
func _run_quick_setup() -> void:
	...
	var base: String = "res://addons/forgekit/resources/"
...
func _on_open_scene_generator() -> void:
	var generator_script = load("res://addons/forgekit/editors/fk_scene_generator_dialog.gd")
...
func _open_dialogue_graph_editor(resource: Resource) -> void:
	var editor_script = load("res://addons/forgekit/editors/fk_dialogue_graph_editor.gd")
...
func _open_skill_tree_graph_editor(resource: Resource) -> void:
	var editor_script = load("res://addons/forgekit/editors/fk_skill_tree_graph_editor.gd")
	var editor_window = editor_script.new()
	editor_window.editor_plugin = editor_plugin
	if editor_plugin:
		editor_plugin.get_editor_interface().get_base_control().add_child(editor_window)
...
func _on_open_damage_formula() -> void:
	var formula_script = load("res://addons/forgekit/editors/fk_damage_formula_dialog.gd")
...
func _on_open_validation() -> void:
	var validation_script = load("res://addons/forgekit/editors/fk_validation_dialog.gd")
...
func _on_open_import_export() -> void:
	var ie_script = load("res://addons/forgekit/editors/fk_import_export_dialog.gd")
