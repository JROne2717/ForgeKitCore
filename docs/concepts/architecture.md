...
Advanced files will live in `addons/forgekit/advanced/`. When this folder does not exist, the dock does not show Advanced-related buttons. No errors, no missing features, no nag screens.
