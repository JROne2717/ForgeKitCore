...
**Fix:** Make sure `addons/forge_kit/icons/` exists and contains the SVG files. After copying them in, let Godot reimport (it does this automatically on focus). You may need to restart the editor.
